![Icon](https://github.com/easonwong-de/Adaptive-Tab-Bar-Colour/blob/main/images/ATBC_128.png)  
...
![Sponsors](https://img.shields.io/badge/sponsors-10-green)
...
<ol>
	<li>Firefox under <a href="https://www.mozilla.org/firefox/112.0/releasenotes/">Version 112.0</a> (released on April, 2023)</li>
...
A CSS theme can work with [ATBC](## "Adaptive Tab Bar Colour"), when system colour variables are being used. <a href="https://github.com/easonwong-de/WhiteSurFirefoxThemeMacOS">This</a> is an example of an [ATBC](## "Adaptive Tab Bar Colour")-compatible CSS theme.
